...
const PlaceHolder = ({ control }: PlaceHolderPropsType) => {
  ...
  return (
    <Box
      display="grid"
      gap={2}
      sx={placeHolderStyle(theme, placeHolderInfo?.type)}
          ...
          {form.end_time ? (
            <Typography>
              <Localizer
                ...
                params={{
                  endTime: format(toDate(form.end_time), "hh:mm yyyy/MM/dd"),
                }}
              />
            </Typography>
          ) : null}
          {hasRemainDuration && remainDuration ? (
            <Typography>
              <Localizer
                ...
                params={{
                  remainDuration: formatDuration(remainDuration),
                }}
              />
            </Typography>
          ) : null}
